...
from parameter import parameter_eryag_time_length_0_3000 as param
...
def train(args,epoch_start,state):
    ...
    data_manager = dm.DataManager_Time(data_train, args.samplerate, args.frequencyrange)
    data_manager_validate = dm.DataManager_Time(data_validate, args.samplerate, args.frequencyrange)
    ...
    if args.model == "cnn_frequency":
        ...
        model = m.ConvClasi_time_length(data_manager.input_size, num_classes=len(args.classes))
