...
ff_0 = [min(freq), 0.115, 0.1, 0.27, 0.53]; %[0.8,0.45,0.35,.25,.2,.15];
ff_1 = [0.8, 0.27, 0.37, 0.53, 0.8];
frange = 0:0.025:1;
ii = 0.015; 0.025;
frange = min(range)-0.05+[0 ii ii ii ii];
frange = [frange(1:2),frange(2)+ii,frange(3:end)];
o = ones(2,1);
...
legend('Activity Map (Grad-CAM)','0.100-0.80 Mhz','0.115-0.27 Mhz','0.100-0.37 Mhz','0.270-0.53 Mhz','0.530-0.80 Mhz','FontSize', xFont)
