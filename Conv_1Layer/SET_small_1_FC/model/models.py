...
#        self.fc1 = nn.Linear(96, 1000)            # self.fc1 = nn.Linear(2148, 1000), freq = [1e5, 1e6]
#        self.fc3 = nn.Linear(1000, num_classes)
        self.conv0 = nn.Conv1d(1, channels_out, kernel_size)
        self.fc1 = nn.Linear(204, 1000)
        self.fc2 = nn.Linear(1000, 1000) #freq = [1e5, 1e6]
        self.fc3 = nn.Linear(1000, num_classes)

#        self.fc1 = nn.Linear(70, 70)
#        self.fc2 = nn.Linear(70, 70) #freq = [1e5, 1e6]
