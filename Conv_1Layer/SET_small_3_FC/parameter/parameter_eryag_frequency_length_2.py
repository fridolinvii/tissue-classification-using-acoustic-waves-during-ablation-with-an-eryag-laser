...
parser.add_argument(
    '--path',
    default='/home/carlo/Documents/Deeplearning/Tissue_Differentiation_Microphone_25.07.2019/data/ErYAG/time',
...
parser.add_argument(
    '--result-path',
    default='data/ErYAG/frequency_results_length_2',
...
parser.add_argument(
    '--epoch-path',
    default='data/ErYAG/epoch_frequency_length_2/',
