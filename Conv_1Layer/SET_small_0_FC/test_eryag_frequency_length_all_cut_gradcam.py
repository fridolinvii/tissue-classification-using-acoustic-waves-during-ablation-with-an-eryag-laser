...
frequencyrange = args_load.frequencyrange

path = 'data/ErYAG/frequency_results_length_1/model_best.pt'
state = th.load(path, map_location="cpu")
args_load = state['args']
args_load.frequencyrange = frequencyrange
...
data_manager = dm.DataManager_Frequency_cut_gradcam(args_load.path,args_load.evaluatecsv_path, args_load.timerange, args_load.samplerate, args_load.frequencyrange,  args=None) 
