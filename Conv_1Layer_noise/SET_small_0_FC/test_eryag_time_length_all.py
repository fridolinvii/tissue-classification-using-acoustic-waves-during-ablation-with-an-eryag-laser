...
data_manager = dm.DataManager_Time_noise(args_load.path,args_load.evaluatecsv_path, args_load.timerange, args_load.samplerate, args_load.frequencyrange,  args=None) 
