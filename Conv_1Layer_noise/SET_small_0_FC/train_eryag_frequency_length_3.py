...
from parameter import parameter_eryag_frequency_length_3 as param
...
#    viz = vis.Visdom(port=args.port)
    ...
    # create data manager
    data_manager = dm.DataManager_Frequency_noise(args.path,args.traincsv_path, args.timerange, args.samplerate, args.frequencyrange, noise=True,  args=None) 
    data_manager_test = dm.DataManager_Frequency_noise(args.path,args.testcsv_path, args.timerange, args.samplerate, args.frequencyrange, noise=False, args=None) 
...
if __name__ == "__main__":
    ...
    mod = 1
    if (mod==1):
        path = 'data/ErYAG/frequency_results_length_3/model_best.pt'
        print("Loading...")
