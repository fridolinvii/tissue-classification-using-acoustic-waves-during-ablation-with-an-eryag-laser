...
def objective(trial):
    ...
    error = train(args, epoch_start, params, data_train, data_validate, data_test,in_data)
    print("*****************************")
...
def train(args, epoch_start, params, data_train, data_validate, data_test, in_data):
    ...
    data_test = dm.createPCADecomposition_apply(args=args,data=data_test,pca=pca)
